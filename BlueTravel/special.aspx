<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="special.aspx.cs" Inherits="BlueTravel.Meishi" %>
		...
		<div class="content clearfix">
        	<div class="leftbar">
            	<div class="leftnav">
                	<h1>风景景点</h1>
                	<ul class="ul_left">
                        <li><h3><a href="Introduce.aspx">景点介绍</a></h3></li> 
        	...
        	<div class="rightbar">
            	<div class="bread"><a href="/Index.aspx">首页</a> > 景点介绍</div>    
            	<div class="con_news">
                	<p class="p_tit2">
                    	<span>景点介绍</span>
