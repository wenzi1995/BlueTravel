<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Historic.aspx.cs" Inherits="BlueTravel.Historic1" %>
		...
		<div class="content clearfix">
        	<div class="leftbar">
            	<div class="leftnav">
                	 <h1>话说南宁</h1>
                   <ul class="ul_left">
                      <li><h3><a href="Introduce.aspx">南宁简介</a></h3></li> 
                      <li><h3><a href="Culture.aspx">南宁文化</a></h3></li>
                      <li><h3><a href="Historic.aspx">南宁历史</a></h3></li>	
         	       </ul>                 
                 </div>
                <div class="left_lx">
                	<h1>联系方式</h1>
        	...
        	<div class="rightbar">
            	<div class="bread"><a href="/Index.aspx">首页</a> > 南宁历史</div>    
            	<div class="con_news">
                	    <p class="p_tit2">
                    	    <span>南宁历史</span>
                	...
                	<div class="con">              
	                    <p>	&nbsp;&nbsp;&nbsp;&nbsp;南宁历史悠久，在古代，南宁属于百越领地。秦始皇统一岭南地区后，南宁属于桂林郡。西汉时期，汉武帝又将它置于玉林郡管辖。东晋大兴元年（公元318年），置大兴郡，以南宁为郡治所在地，南宁建制从此开始，至今已有1600多年。唐朝贞观八年（公元634年），一说贞观六年（公元632年），唐太宗将该地命名为邕州，设邕州下都督府，这就是南宁简称“邕”的由来。
                            <br />
