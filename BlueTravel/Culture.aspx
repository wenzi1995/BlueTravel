<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Culture.aspx.cs" Inherits="BlueTravel.Culture" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!--content开始-->
		...
		<div class="content clearfix">
        	...
        	<div class="rightbar">
            	<div class="bread"><a href="/Index.aspx">首页</a> > 南宁文化</div>               
            	<div class="con_news">
                	<p class="p_tit2">
                    	<span>南宁文化</span>
