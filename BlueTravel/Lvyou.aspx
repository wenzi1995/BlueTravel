<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Lvyou.aspx.cs" Inherits="BlueTravel.history" %>
		...
		<div class="content clearfix">
        	<div class="leftbar">
            	<div class="leftnav">
                	<h1>南宁</h1>
                	<ul class="ul_left">                                     
                        <li><h3><a href="Introduce.aspx">旅游景点</a></h3></li> 
         	        </ul>             
                </div>
                <div class="left_lx">
                	<h1>联系方式</h1>
